...
void StockObjectsD3D11::Destroy() {
	for (int i = 0; i < 16; i++) {
		blendStateDisabledWithColorMask[i] = nullptr;
	}
	depthStencilDisabled = nullptr;
	depthDisabledStencilWrite = nullptr;
	rasterStateNoCull = nullptr;
	samplerPoint2DWrap = nullptr;
	samplerLinear2DWrap = nullptr;
	samplerPoint2DClamp = nullptr;
	samplerLinear2DClamp = nullptr;
}
