...
std::shared_ptr<CDisasm> DialogManager::NewCDisasm(HINSTANCE _hInstance, HWND _hParent, DebugInterface *cpu)
{
...
std::shared_ptr<CMemoryDlg> DialogManager::NewCMemoryDlg(HINSTANCE _hInstance, HWND _hParent, DebugInterface *_cpu)
{
...
std::shared_ptr<CVFPUDlg> DialogManager::NewCVFPUDlg(HINSTANCE _hInstance, HWND _hParent, DebugInterface *cpu_)
{
