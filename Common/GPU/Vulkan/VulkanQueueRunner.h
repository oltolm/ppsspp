...
private:
	...
	void ApplyMGSHack(std::vector<std::unique_ptr<VKRStep>> &steps);
	void ApplySonicHack(std::vector<std::unique_ptr<VKRStep>> &steps);
	void ApplyRenderPassMerge(std::vector<std::unique_ptr<VKRStep>> &steps);
